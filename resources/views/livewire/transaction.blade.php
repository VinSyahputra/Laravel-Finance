            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post" id="formTransaction" class="row">
                        ...
                        <input type="hidden" name="user_id" id="trans_user_id" value="{{ $user->id }}">
                        <!-- Date Field -->
...
@push('scripts')
    ...
    <script>
        if (!window.transactionEventBound) {
            window.transactionEventBound = true;
            document.addEventListener('livewire:navigated', () => {
                if (document.body.id !== 'transaction') return;
        ...
        function btnActionSaveTransaction() {
